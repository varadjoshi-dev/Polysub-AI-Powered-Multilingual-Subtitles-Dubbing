...
const ISO_TO_NLLB_MAP: { [key: string]: string } = {
  "hi": "hin_Deva", "mr": "mar_Deva", "bn": "ben_Beng", "gu": "gu_Gujr", "pa": "pan_Guru",
...
const getNllbCode = (shortCode: string): string => {
  if (shortCode.includes("_")) return shortCode;
            ...
            {job.langs.map((l) => (
              ...
              >
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    downloadBlob(createSrt(l.code), `subtitles-${l.code}.srt`, "text/plain")
                  }
                >
            ...
            {job.langs.map((l) => (
              ...
              >
                ...
                <Button
                  ...
                  onClick={() =>
                    downloadBlob(
                      "[placeholder] Dubbed MP4 not generated in demo",
                      `dubbed-${l.code}.txt`,
                      "text/plain"
                    )
                  }
